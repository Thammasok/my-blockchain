...
describe('Blockchain', () => {
  ...
  describe('isValidChain()', () => {
    describe('when the chain dose start with the genesis block', () => {
      it('return false', () => {
    ...
    describe('when the chain starts with genesis block and has multiple block', () => {
      beforeEach(() => {
        ...
        blockchain.addBlock({ data: 'Battlestar Galactic' })
      })
      ...
      describe('and the chain contains a block with a jumped difficulty', () => {
        it('return true', () => {
          ...
          const nonce = 0
          const data = []
          const difficulty = lastBlock.difficulty - INITIAL_DIFFICULTY // INITIAL_DIFFICULTY = 3
  ...
  describe('replaceChain()', () => {
    ...
    describe('when the chain is longer', () => {
      beforeEach(() => {
        ...
        newChain.addBlock({ data: 'Battlestar Galactic' })
      })
